  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/home"
          element={<Home UserName={UserName} isLoggedIn={isLoggedIn} logout={logout} />}
        />
        ...
        <Route path="/clothing-accessories">
          ...
          <Route path="/clothing-accessories/men">
            ...
            <Route path="/clothing-accessories/men/formals" element={<Formals />} />
            <Route path="/clothing-accessories/men/casuals" element={<Casuals />} />
            <Route path="/clothing-accessories/men/accessories" element={<Accessories />} />
          </Route>
          <Route path="/clothing-accessories/women">
            <Route index element={<Woman />} />
            <Route path="/clothing-accessories/women/formals" element={<Formals />} />
            <Route path="/clothing-accessories/women/dresses" element={<Casuals />} />
            <Route path="/clothing-accessories/women/accessories" element={<Accessories />} />
          </Route>
        </Route>
